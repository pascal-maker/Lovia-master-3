...
// const WINDOW_HEIGHT = Dimensions.get('window').height/10;
// const SCREEN_HEIGHT = Dimensions.get("screen").height;

const lightColorSet = {
  mainThemeBackgroundColor: "#ffffff",
  mainThemeForegroundColor: "#3c9c94",
...
const navBottomLight = {
  primary: "#2C4454",
  secondary: invert("#2C4454"),
};

const navBottomDark = {
  primary: invert("#2C4454"),
  secondary: "#2C4454",
};
...
const navBottomThemeConstants = {
  light: navBottomLight,
  dark: navBottomDark,
  "no-preference": navBottomLight,
  main: "#4991ec",
};
...
const StyleDict = {
  ...
  navBottomThemeConstants: navBottomThemeConstants,
  colorSet: _colorSet,
  iconSet: _iconSet,
  sizeSet: _sizeSet,
  fontSet: _fontSet,
