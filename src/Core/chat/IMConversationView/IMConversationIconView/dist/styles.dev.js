...
var VIEW_WIDTH = 60;
var MULTI_ICON_WIDTH = 40;
var RADIUS_BORDER_WIDTH = 2;
var TOP_ICON_WIDTH = MULTI_ICON_WIDTH + RADIUS_BORDER_WIDTH * 2;
var ONLINE_MARK_WIDTH = 9 + RADIUS_BORDER_WIDTH * 2;

var dynamicStyles = function dynamicStyles(appStyles, colorScheme) {
  return _reactNative.StyleSheet.create(_defineProperty({
    container: {},
    singleParticipation: {
      height: VIEW_WIDTH,
      width: VIEW_WIDTH
