...
export const subscribeToInboundSwipesDislike = (userId, callback) => {
  return swipesRef
    .where("swipedProfile", "==", userId)
    .where("type", "==", "dislike")
...
export const subscribeToOutboundSwipesAll = (userId, callback) => {
  return swipesRef
    .where("author", "==", userId)
    .onSnapshot((querySnapshot) => onCollectionUpdate(querySnapshot, callback));
};
...
export const subscribeToOutboundSwipesDislike = (userId, callback) => {
  return swipesRef
    .where("author", "==", userId)
    .where("type", "==", "dislike")
    .onSnapshot((querySnapshot) => onCollectionUpdate(querySnapshot, callback));
...
export const addSwipe = (fromUserID, toUserID, type, callback) => {
  console.log(
    "fromUserID, toUserID, type, callback : ",
    fromUserID,
    toUserID,
    type,
    callback
